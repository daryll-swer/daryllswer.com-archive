...
I have had a few back-and-forth with a fellow blogger, on a series of blog posts on the subject of IPv4, NAT, CGNAT and IPv6[[1](https://blog.ipspace.net/2025/03/response-end-to-end-connectivity/#2585)][[2](https://blog.ipspace.net/2025/04/response-nat-traversal/)][[3](https://blog.ipspace.net/2025/04/response-peer-to-peer-apps-ipv6/)], along with consistently seeing people who do not understand the right way to do NAT-ting in general, motivated me to write this blog post.
...
You don’t have to take my word for it, read a book or two about these acronyms[[6](https://webrtcforthecurious.com/)], to see the insane complexity brought upon us by those who insisted NAT-ting > routing (hello IPv6!).
...
“But this is hypothetical, isn’t it?” — Nope, you need to think about this in large scale SP networks and campus networks, a lot of endpoint-to-endpoint traffic does exist on everyday end-user applications like WhatsApp P2P calling for example, at large scale, so much traffic is TURN-relayed back into the public Internet, when it could’ve just stayed intra-AS or intra-LAN, with hairpinning[[8](https://www.linkedin.com/feed/update/urn:li:activity:7315988308252086273?commentUrn=urn%3Ali%3Acomment%3A%28activity%3A7315988308252086273%2C7316010203462696961%29&dashCommentUrn=urn%3Ali%3Afsd_comment%3A%287316010203462696961%2Curn%3Ali%3Aactivity%3A7315988308252086273%29)] or in the case of native **routed** IPv6.

“Oh, but I’m a DC operator, I’m not an ISP or Enterprise, NAT is harmless for us, right?” — No. Give this podcast a listen[[9](https://www.buzzsprout.com/2127872/episodes/16106562)], NAT has insane overhead even at hyperscaler companies like Meta or Google.
...
1. We start by enabling hairpinning[[7](https://www.rfc-editor.org/rfc/rfc4787#section-6)] to ensure that intra-(CG)NAT traffic on the LAN or AS works correctly, this gets rid of TURN for intra-NAT traffic.
2. Then we enable EIM & EIF on the NAT device[[10](https://datatracker.ietf.org/doc/html/rfc7857#section-5)] for port range 1024-65535 for both TCP and UDP, this will help ensure P2P traffic continues to work for TCP/UDP, it will get rid of TURN for general global NAT-ted traffic that egresses from the (CG)NAT device.
...
No, it isn’t[[12](https://www.f5.com/resources/white-papers/the-myth-of-network-address-translation-as-security)][[13](https://samy.pl/slipstream/)] — If you need a firewall, then you enable a firewall for both IPv4 and IPv6, NAT isn’t a firewall technology.
